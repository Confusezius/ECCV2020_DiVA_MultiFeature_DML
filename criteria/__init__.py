...
from criteria import moco, adversarial_separation, fast_moco, invariant_spread, dc, imrot, oproxy
import copy
...
def select(loss, opt, to_optim, batchminer=None):
    ...
    if loss_lib.REQUIRES_BATCHMINER: loss_par_dict['batchminer'] = batchminer
