...
class BatchMiner():
    def __init__(self, opt):
        self.par          = opt
        self.lower_cutoff = opt.miner_anticollapse_cdistance_lower_cutoff
        self.upper_cutoff = opt.miner_anticollapse_cdistance_upper_cutoff
        self.contrastive_p = opt.miner_anticollapse_cdistance_cp
